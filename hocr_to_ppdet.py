...
def hocr_to_ppdet(image_folder, hocr_folder, annotation_filepath):
...
# hocr_to_ppdet("data/ao/images/train", "data/ao/hocr", "data/ao/train.txt")
hocr_to_ppdet("data/ao/images/test", "data/ao/hocr", "data/ao/test.txt")
